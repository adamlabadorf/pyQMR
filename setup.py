...
setup(
    ...
    description='MapReduce implementation using pure python and qsub',
    long_description="""\
...
(e.g. -P, etc).""",
    ...
    url='https://github.com/adamlabadorf/pyQMR',
    ...
    keywords='cluster computing SGE TORQUE MapReduce',

    # You can just specify the packages manually here if your project is
    # simple. Or you can use find_packages().
    packages=find_packages('src',exclude=['scripts', 'doc', 'tests*']),
    package_dir= {'':'src'},
